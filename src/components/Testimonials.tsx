        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 border border-gray-200 shadow-lg rounded-lg flex flex-col items-center">
            ...
            <p className="text-lg mb-4 text-gray-600 italic">
              &quot;DealDeX offers an incredible shopping experience. The
              variety and deals are unmatched!&quot;
            </p>
          ...
          <div className="bg-white p-8 border border-gray-200 shadow-lg rounded-lg flex flex-col items-center">
            ...
            ></i>
            <p className="text-lg mb-4 text-gray-600 italic">
              &quot;The convenience of having everything in one place is
          ...
          <div className="bg-white p-8 border border-gray-200 shadow-lg rounded-lg flex flex-col items-center">
            ...
            ></i>
            <p className="text-lg mb-4 text-gray-600 italic">
              &quot;Great selection and fantastic deals. DealDeX has become my
              go-to shopping platform!&quot;
            </p>
            <h5 className="text-xl font-semibold text-gray-800">
              Loyal Customer
            </h5>
